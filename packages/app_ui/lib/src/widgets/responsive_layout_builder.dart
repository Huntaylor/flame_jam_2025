  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        if (constraints.maxWidth <= SatellitesBreakpoints.small) {
          return small(context, child);
        } else if (constraints.maxWidth <= SatellitesBreakpoints.medium) {
          return (medium ?? large).call(context, child);
        } else if (constraints.maxWidth <= SatellitesBreakpoints.large) {
